...
export default class Login extends Component {
  ...
  render(){
      ...
      <Image source={require('../images/minion.png')} resizeMode="contain" style={{width:220}} />
      <Text style={{fontSize:20, color:'#dec373', fontWeight:'600'}}>Minion</Text>
      ...
      <TouchableOpacity onPress={() => this.props.navigator.replace({id:'me'})} style={{backgroundColor:'rgba(116, 115, 222, 0.5)', flex:1, justifyContent:'center', alignItems:'center'}}><Text style={{color:'#fff', fontSize:12, fontWeight:'700'}}>LOG IN</Text></TouchableOpacity>
